 ...
 */
final class Version20210609162449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick_image RENAME INDEX idx_e1204e03256915b TO IDX_E1204E0B281BE2E');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick_image RENAME INDEX idx_e1204e0b281be2e TO IDX_E1204E03256915B');
    }
}
